...
public class MapperPlugin extends PluginAdapter {
    ...
    private void genComments(List<Element> elements) {
        TextElement textElement;
        textElement = new TextElement("<!--");
        elements.add(textElement);
        textElement = new TextElement("  WARNING - @mbggenerated");
        elements.add(textElement);
        textElement = new TextElement("  This element is automatically generated by MyBatis Generator, do not modify.");
        elements.add(textElement);
        textElement = new TextElement("-->");
        elements.add(textElement);
    }
